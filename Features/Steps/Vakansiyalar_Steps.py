...
@step('Select Vakansiya submodule')
def select_category_cr_item_Vakansiya(context): context.WebSite.Vakansiyalar_Page.select_category_cr_item_Vakansiya()


@step('Select İş axtarıram submodule')
def select_category_cr_item_IsAxtariram(
        context): context.WebSite.Vakansiyalar_Page.select_category_cr_item_IsAxtariram()
...
def select_category_cr_item_IsTecrubesi(
        context): context.WebSite.Vakansiyalar_Page.select_category_cr_item_IsTecrubesi()
