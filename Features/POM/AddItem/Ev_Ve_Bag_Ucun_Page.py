...
class EvVeBagUcunPage(Page):
    _clickOnSelectButtonCREvBag = By.XPATH, '//a[@data="{id:899,pid:1,subs:1,title:\'Ev və bağ üçün\'}"]'
    _clickOnSelectButtonCRErzaq = By.XPATH, '//a[@data="{id:1429,pid:899,subs:0,title:\'Ərzaq\'}"]'
